...
export class ReserveAuctionCoreErc20RoyaltyPayout extends ethereum.Event {
  get params(): ReserveAuctionCoreErc20RoyaltyPayout__Params {
    return new ReserveAuctionCoreErc20RoyaltyPayout__Params(this);
  }
}

export class ReserveAuctionCoreErc20RoyaltyPayout__Params {
  _event: ReserveAuctionCoreErc20RoyaltyPayout;

  constructor(event: ReserveAuctionCoreErc20RoyaltyPayout) {
    this._event = event;
  }
